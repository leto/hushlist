...
\newcommand{\leadauthor}{David Mercer <radi42@gmail.com>}
...
\Large \coauthora\affiliationDuke }
\date{\today}
\maketitle
...
on all chains.  HushList is developed and tested on the Hush mainnet and testnets and is kknown is designed to run on any \ZEC fork including but not limited to \HUSH, \KMD, \ZCL, \ZEN.
...
Multipart sends and public HushLists are still in development.
...
the \LaTeX infrastructure open source, which was used to make this document.
